...
<div class="ui grid">
            ...
            <div class="ui card" style="width: 100%; " id="user_card">
                <div class="blurring dimmable image" id="avatar_container" style="height:325px">
                    ...
                    <div class="ui dimmer transition hidden">
                        <div class="content">
                            <div class="center">
                                <!-- <a class="ui inverted button" href="modifypage.php"><i class="edit icon"></i>修改资料</a> -->
                            </div>
                        </div>
                    </div>
                    <?php 
                    $default = "https://www.bttcacm.cn/default.png";
 ...
 ?>
                ...
                <div class="content">
                    <div class="header"><?php echo $user?> <?php echo $nick?></div>
                    <div class="meta">
                                ...
                                <div class="ui grid">
                                    <div class="row">
                                        <div class="column">
                                           ...
                                           <div class="ui bottom attached segment"><?php echo $user?> <?php echo $nick?></div>
                                        </div>
                                    </div>
                                      <div class="row">
                                          <div class="column">

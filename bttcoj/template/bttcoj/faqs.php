...
<div class="padding">
    ...
    <div style="font-content">
        ...
        <p>
			本系统运行在操作系统为Ubuntu 16.04.3 LTS的服务器上，目前支持评测C/C++,JAVA,PASCAL,Python编程语言。
			<br> C++ 使用 <code>g++ 7.4.0</code> 编译，命令为 &nbsp;<code>g++ -fno-asm -O2 -fmax-errors=10 -Wall -lm --static -std=c++14 -DONLINE_JUDGE -o Main Main.cc</code>；
			<br> C++ 使用 <code>clang++ 3.8.0</code> 编译，命令为 &nbsp;<code>clang++ -fno-asm -O2 -fmax-errors=10 -Wall -lm --static -std=c++0x -DONLINE_JUDGE -o Main Main.cc</code>；
            <br> C 使用 <code>gcc 7.4.0</code> 编译，命令为 &nbsp;<code>gcc Main.c -o Main -O2 -fmax-errors=10 -Wall -lm --static -std=c99 -DONLINE_JUDGE</code>；
            <br> C 使用 <code>clang 3.8.0</code> 编译，命令为 &nbsp;<code>clang Main.c -o Main -O2 -fmax-errors=10 -Wall -lm --static -std=c99 -DONLINE_JUDGE</code>；
            <br> Pascal 使用 <code>fpc 3.0.0</code> 编译，命令为 &nbsp;<code>fpc Main.pas -Cs32000000 -Sh -O2 -Co -Ct -Ci</code>。
            <br> Java 使用 <code>OpenJDK 1.8.0</code> 编译，命令为 <code>javac -J-Xms64M -J-Xmx128M -encoding UTF-8 Main.java</code>，如果您的代码中没有 <code>public class</code>，请将入口类命名为 <code>Main</code>。
            <br> Python 目前使用Python3，暂不支持Python2。
            <br>
        </p>
...
for line in sys.stdin:
    print(sum(map(int, line.split())))</code></pre></div>
...
<code class="lang-c">while True:
    ...
    if raw == '':
        break
    print(sum(map(int, raw.split())))</code></pre></div>
    </div>
</div>
